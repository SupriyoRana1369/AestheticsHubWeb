...
const WhatYouWillGet = () => {
  return (
    <div className="flex flex-col-reverse lg:flex-row items-center justify-center gap-10 p-10 bg-black text-white">
      {/* Left side (Image) */}
      ...
      {/* Right side (Text) */}
      <div className="flex-1 items-center justify-center text-center lg:text-left">
        <h1 className="text-[2rem] lg:text-[3rem] leading-none font-bold mb-4">
          Global Private Network
        </h1>
        <div className="space-y-2 text-base lg:text-lg leading-normal">
